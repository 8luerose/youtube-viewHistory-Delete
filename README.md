...
> YouTube 시청 기록에서 영상을 **1클릭**으로 삭제하는 Tampermonkey 스크립트 (2026 버전)

## 🎯 기능

| 기능 | 설명 |
|------|------|
| 🗑️ 일반 비디오 삭제 | 썸네일 좌측 하단 휴지통 버튼으로 1클릭 삭제 |
| 🗑️ 쇼츠 개별 삭제 | 쇼츠 썸네일 좌측 하단 휴지통 버튼으로 1클릭 삭제 |
| 📦 쇼츠 섹션 전체 삭제 | "Shorts" 타이틀 옆 "해당 줄 지우기" 버튼으로 섹션 전체 삭제 |
...
3. 쇼츠 섹션 "Shorts" 타이틀 옆 **"해당 줄 지우기"** 버튼 확인
4. 클릭 → 영상 즉시 삭제 ✅
...
└─────────────────────┬───────────────────────────────────┘
                      ▼
┌─────────────────────────────────────────────────────────┐
│  각 쇼츠 순차적으로 "추가 작업" → "시청 기록에서 삭제"  │
└─────────────────────┬───────────────────────────────────┘
                      ▼
┌─────────────────────────────────────────────────────────┐
│  모든 쇼츠 삭제 완료 → 섹션 fadeOut → .remove()         │
└─────────────────────────────────────────────────────────┘
```
